...
Definition at line 431 of file lsredis.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( strlen(v) >= p->\hyperlink{structlsredis__obj__struct_a664f0eaafb8dffc0dbde126e0340efb9}{value\_length}) \{
    ...
    \}
  \}
  strncpy( p->\hyperlink{structlsredis__obj__struct_a0465c65288e8101805a6f91049164517}{value}, v, p->\hyperlink{structlsredis__obj__struct_a664f0eaafb8dffc0dbde126e0340efb9}{value\_length} - 1);
  ...
  p->\hyperlink{structlsredis__obj__struct_a26211a0ab3fc02e7776e24dbc1f1256c}{lvalue} = strtol( p->\hyperlink{structlsredis__obj__struct_a0465c65288e8101805a6f91049164517}{value}, NULL, 10);
  ...
  \textcolor{keywordflow}{if}( p->\hyperlink{structlsredis__obj__struct_ac065eeede0e08f25bcfedd45022fe593}{avalue} != NULL) \{
    ...
    \textcolor{keywordflow}{for}( i=0; (p->\hyperlink{structlsredis__obj__struct_ac065eeede0e08f25bcfedd45022fe593}{avalue})[i] != NULL; i++)
      free( (p->\hyperlink{structlsredis__obj__struct_ac065eeede0e08f25bcfedd45022fe593}{avalue})[i]);
...
Definition at line 397 of file lsredis.\-c.
...
Definition at line 748 of file lsredis.\-c.
...
Definition at line 933 of file lsredis.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( regexec( &\hyperlink{lsredis_8c_abee04898347f9b2551fa0435b1cc597e}{lsredis\_key\_select\_regex}, k, 0, NULL, 0
    ...
    \textcolor{comment}{/*  }
\textcolor{comment}{    last  = NULL;}
\textcolor{comment}{    last2 = NULL;}
\textcolor{comment}{    for( p=lsredis\_objs; p != NULL; p = p->next) \{}
\textcolor{comment}{      if( strcmp( p->key, k) == 0) \{}
\textcolor{comment}{        p->hits++;}
\textcolor{comment}{        //}
...
\textcolor{comment}{        // That "hits+4" keeps us from oscillating when objects are accessed
       equally}
\textcolor{comment}{        //}
\textcolor{comment}{        if( last != NULL && last->hits < p->hits+4) \{}
\textcolor{comment}{          last->next = p->next;}
\textcolor{comment}{          p->next    = last;}
\textcolor{comment}{          if( last2 != NULL)}
\textcolor{comment}{            last2->next = p;}
\textcolor{comment}{          else}
\textcolor{comment}{            lsredis\_objs = p;}
\textcolor{comment}{        \}}
\textcolor{comment}{        break;}
\textcolor{comment}{      \}}
\textcolor{comment}{      last2 = last;}
\textcolor{comment}{      last  = p;}
\textcolor{comment}{    \} }
\textcolor{comment}{    */}
...
Definition at line 952 of file lsredis.\-c.


\begin{DoxyCode}
                                    \{
  \textcolor{keyword}{static} \textcolor{keywordtype}{int} poll\_timeout\_ms = 100;     
