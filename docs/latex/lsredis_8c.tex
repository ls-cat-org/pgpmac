...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( p->\hyperlink{structlsredis__obj__struct_ac065eeede0e08f25bcfedd45022fe593}{avalue} != NULL) \{
    \textcolor{keywordtype}{char} **zz;
    \textcolor{keywordflow}{for}( zz = p->\hyperlink{structlsredis__obj__struct_ac065eeede0e08f25bcfedd45022fe593}{avalue}; *zz != NULL; zz++)
      free( zz);
  ...
  \textcolor{keywordflow}{switch}( *(p->\hyperlink{structlsredis__obj__struct_a0465c65288e8101805a6f91049164517}{value})) \{
      ...
      \textcolor{keywordflow}{default}:
        p->\hyperlink{structlsredis__obj__struct_ac3df3eaa275c1e8e333024c1fa8353af}{bvalue} = -1;           \textcolor{comment}{// a little unusual for a null value to
       be -1}
    \}
