...
\begin{DoxyCode}
                         \{
  \textcolor{keyword}{static} \textcolor{keywordtype}{char} s[4096];
  ...
  \textcolor{keywordflow}{for}( i=0; i<\hyperlink{lspmac_8c_a56260f012c50a591ee7f97e500f16994}{lspmac\_nmotors}; i++) \{
    ...
    \} \textcolor{keywordflow}{else} \{
      ...
      \textcolor{keywordflow}{if}( mp->\hyperlink{structlspmac__motor__struct_aa90af2f6f1489f1befe1d0891e51575a}{name} != NULL && mp->\hyperlink{structlspmac__motor__struct_a56c41875faf19c643e97c10519e6eb8c}{status1\_p} != NULL && mp->
      \hyperlink{structlspmac__motor__struct_a2b33ef6e12717459c1e9967cc6e659c6}{status2\_p} != NULL && mp->\hyperlink{structlspmac__motor__struct_a312047bb71def5cd2443fecd875eaea5}{actual\_pos\_cnts\_p} != NULL) \{
        \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"%s status1: %0x  status2:
       %0x  cnts: %d"}, mp->\hyperlink{structlspmac__motor__struct_aa90af2f6f1489f1befe1d0891e51575a}{name}, mp->\hyperlink{structlspmac__motor__struct_acb52b612b9237e8eec0b97fb1e76a35d}{status1}, mp->\hyperlink{structlspmac__motor__struct_a6a412224c09268c1dc92de9c2a1a2512}{status2}, mp->
      ...
      \textcolor{keywordflow}{if}( strlen(s1) + strlen(s) + 32 >= \textcolor{keyword}{sizeof}( s)-1) \{
        \textcolor{comment}{// send off update now and reset s}
        strcat( s, \textcolor{stringliteral}{"\}'::text[])"});
        \hyperlink{lspg_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, s);
        
        \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"Update: %s"}, s);
