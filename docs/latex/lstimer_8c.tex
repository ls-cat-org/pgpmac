...
pthread\-\_\-t $\ast$ \hyperlink{lstimer_8c_aa9fdc057e219c162d67c5cb77a2bf7a4}{lstimer\-\_\-run} ()
...
\}
\end{DoxyCode}
\hypertarget{lstimer_8c_aa9fdc057e219c162d67c5cb77a2bf7a4}{\index{lstimer.\-c@{lstimer.\-c}!lstimer\-\_\-run@{lstimer\-\_\-run}}
...
{}
\end{DoxyParamCaption}
)}}\label{lstimer_8c_aa9fdc057e219c162d67c5cb77a2bf7a4}
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{while}( 1) \{
    ...
    \textcolor{comment}{//}
    pthread\_sigmask( SIG\_SETMASK, &mask, NULL);
    ...
    \textcolor{comment}{//}
    pthread\_sigmask( SIG\_UNBLOCK, &mask, NULL);
  \}
\}
\end{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( i=0; i<\hyperlink{lstimer_8c_a1a47dadbec1776920ab83409234c1833}{lstimer\_active\_timers}; i++) \{
    ...
    \textcolor{keywordflow}{if}( p->\hyperlink{structlstimer__list__struct_ac7ab4cd1f3065156f95b49e66bf05283}{shots} != 0) \{
      ...
      then.tv\_sec && p->\hyperlink{structlstimer__list__struct_acf993c87ab0ee8ffd74c3907022d6996}{next\_nsecs} <= then.tv\_nsec)) \{
        ...
        \textcolor{comment}{//}
        p->\hyperlink{structlstimer__list__struct_a8f881e66431efbed84b6ad029757bc67}{last\_secs}  = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_sec;
        p->\hyperlink{structlstimer__list__struct_a0b2ab04246481397116ac9770c3c6603}{last\_nsecs} = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_nsec;
