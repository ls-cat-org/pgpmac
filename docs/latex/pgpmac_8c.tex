...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( ch=wgetch(\hyperlink{pgpmac_8c_ab0487111dbe3c05d0bd835eb2fb9a3f7}{term\_input}); ch != ERR && \hyperlink{pgpmac_8c_a2f45113638a0b749a8a205d2cd7fb42b}{running}; ch=wgetch(
    ...
    case KEY\_F(3):
      ...
      \hyperlink{lstimer_8c_a7b3e725fbe1bb3cc9f8465941cf1e381}{lstimer\_set\_timer}( \textcolor{stringliteral}{"Quit Program"}, 1, 10, 0);
      \textcolor{keywordflow}{break};
    ...
    \textcolor{keywordflow}{case} 0x0016:        \textcolor{comment}{// Control-V}
      cntrlcmd[0] = ch;
      cntrlcmd[1] = 0;
      \hyperlink{lspmac_8c_adebcd9b5045d49112b704a7656a981c9}{lspmac\_SockSendline}( NULL, cntrlcmd);
    ...
    \textcolor{keywordflow}{case} 0x000a:
      \textcolor{keywordflow}{if}( cmds\_on > 0 && strlen( cmds) > 0) \{
        \hyperlink{lspmac_8c_adebcd9b5045d49112b704a7656a981c9}{lspmac\_SockSendline}( NULL, \textcolor{stringliteral}{"%s"}, cmds);
      \}
