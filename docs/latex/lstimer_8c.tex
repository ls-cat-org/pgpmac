...
\}
\end{DoxyCode}
\hypertarget{lstimer_8c_a14f35a979ca0537d8180d90cbc56c577}{\index{lstimer.\-c@{lstimer.\-c}!lstimer\-\_\-add\-\_\-timer@{lstimer\-\_\-add\-\_\-timer}}
...
\begin{DoxyCode}
  ...
  \hyperlink{structlstimer__list__struct}{lstimer\_list\_t} *p;
  \textcolor{keyword}{struct }timespec \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}, then, soonest;
  ...
  then.tv\_sec  = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_sec + (\hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_nsec + \hyperlink{lstimer_8c_a602d98fa617eb9f4ab49e4b9c7f5d4d9}{LSTIMER\_RESOLUTION\_NSECS}
      ) / 1000000000;
  then.tv\_nsec = (\hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_nsec + \hyperlink{lstimer_8c_a602d98fa617eb9f4ab49e4b9c7f5d4d9}{LSTIMER\_RESOLUTION\_NSECS}
      ) % 1000000000;

  found\_active = 0;
  \textcolor{keywordflow}{for}( i=0; i<\hyperlink{lstimer_8c_a1a47dadbec1776920ab83409234c1833}{lstimer\_active\_timers}; i++) \{
    p = &(\hyperlink{lstimer_8c_a35b456765fe2c955cef445768d12ca6c}{lstimer\_list}[i]);
    \textcolor{keywordflow}{if}( p->\hyperlink{structlstimer__list__struct_ac7ab4cd1f3065156f95b49e66bf05283}{shots} != 0) \{
      found\_active++;
      \textcolor{keywordflow}{if}(  p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs} < then.tv\_sec || (p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs} == 
      then.tv\_sec && p->\hyperlink{structlstimer__list__struct_ab115115d5be7933f98a094b46b6583bb}{next\_nsecs} <= then.tv\_nsec)) \{
        ...
        \textcolor{comment}{//}
        p->\hyperlink{structlstimer__list__struct_ab0ac2907735701cb24ec9af95a1cc787}{last\_secs}  = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_sec;
        p->\hyperlink{structlstimer__list__struct_a19acf5aa7f57aa7ce60537c3d3d6a6af}{last\_nsecs} = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_nsec;
        ...
        \} \textcolor{keywordflow}{else} \{
          p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs}  = p->\hyperlink{structlstimer__list__struct_a1222c76d49b149725467aa698abb7fb1}{init\_secs} + (p->\hyperlink{structlstimer__list__struct_aa56c5b8ce7fa0ae93132cb9908195836}{ncalls}+1) 
      * p->\hyperlink{structlstimer__list__struct_a237da48d81b7e039c54901296aeee18e}{delay\_secs} + (p->\hyperlink{structlstimer__list__struct_ad5bb7fa7d669b7ebbe34d8ed2bdb257a}{init\_nsecs} + (p->\hyperlink{structlstimer__list__struct_aa56c5b8ce7fa0ae93132cb9908195836}{ncalls}+1)*p->
      \hyperlink{structlstimer__list__struct_acb0c6a1600c4168e5dfb2d477a685b29}{delay\_nsecs})/1000000000;
          p->\hyperlink{structlstimer__list__struct_ab115115d5be7933f98a094b46b6583bb}{next\_nsecs} = (p->\hyperlink{structlstimer__list__struct_ad5bb7fa7d669b7ebbe34d8ed2bdb257a}{init\_nsecs} + (p->\hyperlink{structlstimer__list__struct_aa56c5b8ce7fa0ae93132cb9908195836}{ncalls}
      +1)*p->\hyperlink{structlstimer__list__struct_acb0c6a1600c4168e5dfb2d477a685b29}{delay\_nsecs}) % 1000000000;
        \}
      \}

      \textcolor{keywordflow}{if}( found\_active == 1) \{
        soonest.tv\_sec  = p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs};
        soonest.tv\_nsec = p->\hyperlink{structlstimer__list__struct_ab115115d5be7933f98a094b46b6583bb}{next\_nsecs};
      \} \textcolor{keywordflow}{else} \{
        \textcolor{keywordflow}{if}( soonest.tv\_sec > p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs} || (soonest.tv\_sec == p->
      \hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs} && soonest.tv\_nsec > p->\hyperlink{structlstimer__list__struct_ab115115d5be7933f98a094b46b6583bb}{next\_nsecs})) \{
          soonest.tv\_sec  = p->\hyperlink{structlstimer__list__struct_af0dcaad37472462c9f27d54ed0ceb75d}{next\_secs};
          soonest.tv\_nsec = p->\hyperlink{structlstimer__list__struct_ab115115d5be7933f98a094b46b6583bb}{next\_nsecs};
        \}
      \}
