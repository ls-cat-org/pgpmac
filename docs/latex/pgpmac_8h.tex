...
void \hyperlink{pgpmac_8h_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\-\_\-query\-\_\-push} (void($\ast$cb)(\hyperlink{pgpmac_8h_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$, P\-Gresult $\ast$), char $\ast$fmt,...)
...
void \hyperlink{pgpmac_8h_a7497a7c924b31c727ea487a3efb77fb6}{lspg\-\_\-waitcryo\-\_\-cb} (\hyperlink{pgpmac_8h_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
\item 
...
\begin{DoxyCompactList}\small\item\em use dpram ascii interface to send a control character \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Definition at line 487 of file pgpmac.\-h.
...
\begin{DoxyCode}
                                                                     \{
  \textcolor{keywordtype}{char} s[512];
  \textcolor{keywordtype}{int} \hyperlink{namespacemk__pgpmac__redis_afa643a23a5984fe44c2182ada3dfa401}{i}, plength;
  \textcolor{keywordtype}{int} err;
  ENTRY htab\_input, *htab\_output;
  \hyperlink{structlsredis__obj__struct}{lsredis\_obj\_t} *\hyperlink{namespacemk__pgpmac__redis_a11daf2847f2dc94562b5b61b3f412574}{p};

  p = \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}(  \textcolor{stringliteral}{"%s.%s.presets.length"}, \hyperlink{lsredis_8c_acdca9095c7a3288d7febe9f4c440a6e9}{lsredis\_head}
      , base);
  plength = \hyperlink{lsredis_8c_a71689006ffc015be6a0705a7c0aef1be}{lsredis\_get\_or\_set\_l}( p, 0);
  ...
  \textcolor{keywordflow}{for}( i=0; i<plength; i++) \{
    ...
    \textcolor{keywordflow}{if}( err == 0) \{
      \textcolor{comment}{//}
      \textcolor{comment}{// Not found? odd.  Length Lied.}
      \textcolor{comment}{// Might as well just stick our preset here.}
      \textcolor{comment}{//}
      p = \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"%s"}, s);
      \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( p, \textcolor{stringliteral}{"%s"}, preset\_name);
    \} \textcolor{keywordflow}{else} \{
      \textcolor{comment}{// Check if we have a match}
      p = htab\_output->data;
    \}
    ...
    \textcolor{keywordflow}{if}( \hyperlink{lsredis_8c_a9fc8fd0db4c71c5eae68682b43103078}{lsredis\_cmpstr}( p, preset\_name)==0) \{
      ...
      \} \textcolor{keywordflow}{else} \{
        p = htab\_output->data;
      \}
      \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( p, \textcolor{stringliteral}{"%.3f"}, dval);
      \textcolor{keywordflow}{return};
    \}
  \}
  \textcolor{comment}{//}
  ...
  p = \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}(  \textcolor{stringliteral}{"%s.%s.presets.length"}, \hyperlink{lsredis_8c_acdca9095c7a3288d7febe9f4c440a6e9}{lsredis\_head}
      , base);
  \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( p, \textcolor{stringliteral}{"%ld"}, plength + 1);
\}
\end{DoxyCode}
...
Definition at line 254 of file lstimer.\-c.
...
Definition at line 268 of file lstimer.\-c.
