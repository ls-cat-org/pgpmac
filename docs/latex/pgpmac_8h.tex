...
\begin{DoxyCompactList}\small\item\em Move the motors and estimate the time it'll take to finish the job. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Definition at line 119 of file lstest.\-c.
