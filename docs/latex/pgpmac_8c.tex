...
\begin{DoxyCompactItemize}
\item 
void $\ast$ \hyperlink{pgpmac_8c_a0c36f76e2be6333f0241869452b961e4}{sigterm\-Worker} (void $\ast$arg)
\begin{DoxyCompactList}\small\item\em Sigterm is simple. \end{DoxyCompactList}\item 
void \hyperlink{pgpmac_8c_a9127a8f722451b5996ffbc6966f4aa95}{stdin\-Service} (struct pollfd $\ast$evt)
\begin{DoxyCompactList}\small\item\em Handle stdin. \end{DoxyCompactList}\item 
...
int \hyperlink{pgpmac_8c_ae002f31c03cce9bf96cf0e0c2907cb2b}{pgpmac\-\_\-use\-\_\-pg} = 0
...
int \hyperlink{pgpmac_8c_ad163e2bc6ebe322058c113dee76c11ff}{pgpmac\-\_\-use\-\_\-autoscint} = 0
...
\item 
static sigset\-\_\-t \hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\-\_\-sigset}
\item 
static pthread\-\_\-t $\ast$ \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{our\-Threads} \mbox{[}32\mbox{]}
\begin{DoxyCompactList}\small\item\em a list of our threads. \end{DoxyCompactList}\item 
static int \hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{n\-Our\-Threads} = 0
\end{DoxyCompactItemize}
...
\begin{DoxyCode}
  ...
  \textcolor{keyword}{static} \textcolor{keyword}{struct }pollfd fda[4];          \textcolor{comment}{// input for poll: room for postgres,
       pmac, stdin, and SIGTERM handler}
  ...
  \textcolor{comment}{//}
  \textcolor{comment}{// SIGTERM will be captured through the fd mechanism to run a quit routine}
  \textcolor{comment}{//}
  sigemptyset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset});
  sigaddset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, SIGUSR1);
  sigaddset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, SIGTERM);
  sigaddset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, SIGQUIT);
  sigaddset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, SIGINT);
  sigaddset( &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, SIGRTMIN);
  err = pthread\_sigmask(SIG\_BLOCK, &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, NULL);
  \textcolor{keywordflow}{if}( err) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"main: pthread\_sigmask returned
       error"});
  \}
  

  \textcolor{comment}{//}
  \textcolor{comment}{// Get options}
  \textcolor{comment}{//}
  \textcolor{keywordflow}{while}( 1) \{
    ...
    \textcolor{keywordflow}{case} \textcolor{charliteral}{'i'}:           \textcolor{comment}{// store i variables in pg}
      ivars=1;
      \textcolor{keywordflow}{break};

    \textcolor{keywordflow}{case} \textcolor{charliteral}{'m'}:
      mvars=1;          \textcolor{comment}{// store m variables in pg}
      \textcolor{keywordflow}{break};
    \}
  \}

  \textcolor{comment}{//}
  \textcolor{comment}{// Prepare stdin for poll statement}
  \textcolor{comment}{//}
  ...
  \textcolor{comment}{//}
  \textcolor{comment}{// TODO: fork and run ncurses through a pipe}
  \textcolor{comment}{// ncurses is, perhaps, screwing up our signal handling}
  \textcolor{comment}{//}
  ...
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lslogging_8c_ab5d6951193d8b2df1e4dd61c53de76cc}{lslogging\_run}()
      ;
  ...
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lsevents_8c_a7f2ed970b1c3b340b79311e73c5f1e11}{lsevents\_run}();
  ...
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lstimer_8c_aa9fdc057e219c162d67c5cb77a2bf7a4}{lstimer\_run}();
  ...
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lsredis_8c_ac3db3d5f91bf5723bd94748ce0d88731}{lsredis\_run}();
  ...
  \textcolor{comment}{//}
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lspmac_8c_a7101ae7b7aad35767a1d6a7093138bd4}{lspmac\_run}();

  \textcolor{keywordflow}{if}( \hyperlink{pgpmac_8c_ae002f31c03cce9bf96cf0e0c2907cb2b}{pgpmac\_use\_pg})
    \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{lspg_8c_a80df49750b61bb2526618db4253fc4ce}{lspg\_run}();

  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = \hyperlink{md2cmds_8c_abc5270ece18fe48a49947378438049cf}{md2cmds\_run}();

  pthread\_create( &sigterm\_thread, NULL, \hyperlink{pgpmac_8c_a0c36f76e2be6333f0241869452b961e4}{sigtermWorker}, NULL);
  \hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}++] = &sigterm\_thread;

  \textcolor{keywordflow}{while}( \hyperlink{pgpmac_8c_a2f45113638a0b749a8a205d2cd7fb42b}{running}) \{
    \textcolor{comment}{//}
    \textcolor{comment}{// Prepare fda}
    \textcolor{comment}{//}
    nfd = 0;
    ...
    \textcolor{keywordflow}{for}( i=0; pollrtn>0 && i<nfd; i++) \{
      \textcolor{keywordflow}{if}( fda[i].revents) \{
        pollrtn--;
        \textcolor{keywordflow}{if}( fda[i].fd == \hyperlink{pgpmac_8c_a6dc08e82e698d914ccb09077dd33668a}{stdinfda}.fd) \{
...
\begin{DoxyCode}
  ...
  \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"pgpmac\_quit\_cb:
       doomsday\_count=%d, running=%d"}, \hyperlink{pgpmac_8c_aa687f0df65c1d87ffd5635742c1eab94}{doomsday\_count}, \hyperlink{pgpmac_8c_a2f45113638a0b749a8a205d2cd7fb42b}{running});

  \textcolor{keywordflow}{if}( \hyperlink{pgpmac_8c_aa687f0df65c1d87ffd5635742c1eab94}{doomsday\_count} == -2) \{
    \textcolor{keywordtype}{int} \hyperlink{namespacemk__pgpmac__redis_afa643a23a5984fe44c2182ada3dfa401}{i};
    \textcolor{keywordtype}{int} err;

    \textcolor{comment}{// Be nice}
    \textcolor{comment}{//}
    \textcolor{keywordflow}{for}( i=\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}-1; i>=0; i--) \{
      err = pthread\_kill( *\hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[i], 0);
      \textcolor{keywordflow}{if}( err == 0) \{
        pthread\_kill( *\hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[i], 3);
      \}
    \}
    ...
    \textcolor{keywordflow}{if}( \hyperlink{pgpmac_8c_aa687f0df65c1d87ffd5635742c1eab94}{doomsday\_count} < -2) \{
      ...
      \textcolor{comment}{// Be mean}
      \textcolor{comment}{//}
      \textcolor{keywordflow}{for}( i=\hyperlink{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{nOurThreads}-1; i>=0; i--) \{
        err = pthread\_kill( *\hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[i], 0);
        \textcolor{keywordflow}{if}( err == 0) \{
          pthread\_kill( *\hyperlink{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{ourThreads}[i], 9);
        \}
      \}
    \}
  \}
...
\}
\end{DoxyCode}
\hypertarget{pgpmac_8c_a0c36f76e2be6333f0241869452b961e4}{\index{pgpmac.\-c@{pgpmac.\-c}!sigterm\-Worker@{sigterm\-Worker}}
\index{sigterm\-Worker@{sigterm\-Worker}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{sigterm\-Worker}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ sigterm\-Worker (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{arg}
\end{DoxyParamCaption}
)}}\label{pgpmac_8c_a0c36f76e2be6333f0241869452b961e4}
...
\begin{DoxyCode}
                                 \{
  \textcolor{keywordtype}{int} rc;
  \textcolor{keywordtype}{int} sig\_caught;
  sigset\_t the\_sigset;

  sigemptyset( &the\_sigset);
  sigaddset( &the\_sigset, SIGTERM);
  sigaddset( &the\_sigset, SIGQUIT);
  sigaddset( &the\_sigset, SIGINT);
  pthread\_sigmask(SIG\_UNBLOCK, &\hyperlink{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{our\_sigset}, NULL);

  rc = sigwait( &the\_sigset, &sig\_caught);
  \textcolor{keywordflow}{if}( rc) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"sigtermThread: sigwait failed"}
      );
    \textcolor{keywordflow}{return} NULL;
  \}
  
  \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Quitting Program"});
  \hyperlink{lstimer_8c_a7b3e725fbe1bb3cc9f8465941cf1e381}{lstimer\_set\_timer}( \textcolor{stringliteral}{"Quit Program"}, -1, 1, 0);
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( ch=wgetch(\hyperlink{pgpmac_8c_ab0487111dbe3c05d0bd835eb2fb9a3f7}{term\_input}); ch != ERR && \hyperlink{pgpmac_8c_a2f45113638a0b749a8a205d2cd7fb42b}{running}; ch=wgetch(
    ...
    \textcolor{keywordflow}{case} KEY\_F(3):
      endwin();
      exit(0);

    \textcolor{keywordflow}{case} 0x0002:        \textcolor{comment}{// Control-B    Report status word for 8 motors}
    \textcolor{keywordflow}{case} 0x0003:        \textcolor{comment}{// Control-C    Report all coordinate system status
       words}
    \textcolor{keywordflow}{case} 0x0006:        \textcolor{comment}{// Control-F    Report following errors for 8 motors}
    \textcolor{keywordflow}{case} 0x0010:        \textcolor{comment}{// Control-P    Report positions for 8 motors}
    \textcolor{keywordflow}{case} 0x0016:        \textcolor{comment}{// Control-V    Report velocity on 8 motors}
      sprintf( cevt, \textcolor{stringliteral}{"Control-%c"}, \textcolor{charliteral}{'@'} + ch);
      \hyperlink{lspmac_8c_a8707477f9799b4cc8c6f465ecfeee24b}{lspmac\_SockSendControlCharPrint}( cevt, ch)
      ;
      \textcolor{keywordflow}{break};

    \textcolor{keywordflow}{case} 0x0001:        \textcolor{comment}{// Control-A    Abort all programs and moves}
    \textcolor{keywordflow}{case} 0x0004:        \textcolor{comment}{// Control-D    Disable all PLC programs}
    \textcolor{keywordflow}{case} 0x0005:        \textcolor{comment}{// Control-E    Enable disabled motors}
    \textcolor{keywordflow}{case} 0x0007:        \textcolor{comment}{// Control-G    Report global status word}
    \textcolor{keywordflow}{case} 0x000b:        \textcolor{comment}{// Control-K    Kill all motors}
    \textcolor{keywordflow}{case} 0x000f:        \textcolor{comment}{// Control-O    Feed hold on all coordinate systems}
    \textcolor{keywordflow}{case} 0x0011:        \textcolor{comment}{// Control-Q    Quit all executing motion programs}
    \textcolor{keywordflow}{case} 0x0012:        \textcolor{comment}{// Control-R    Run motion programs in all coordinate
       systems}
    \textcolor{keywordflow}{case} 0x0013:        \textcolor{comment}{// Control-S    Step through working motion programs in
       all coordinate systems}
    \textcolor{keywordflow}{case} 0x0018:        \textcolor{comment}{// Control-X    Cancel in-process communications}
      sprintf( cevt, \textcolor{stringliteral}{"Control-%c"}, \textcolor{charliteral}{'@'} + ch);
      \hyperlink{lspmac_8c_a8707477f9799b4cc8c6f465ecfeee24b}{lspmac\_SockSendControlCharPrint}( cevt, ch)
      ;
      \textcolor{comment}{//      lspmac\_SockSendDPControlChar( cevt, ch);}
      \textcolor{keywordflow}{break};
...
\hypertarget{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}{\index{pgpmac.\-c@{pgpmac.\-c}!n\-Our\-Threads@{n\-Our\-Threads}}
\index{n\-Our\-Threads@{n\-Our\-Threads}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{n\-Our\-Threads}]{\setlength{\rightskip}{0pt plus 5cm}int n\-Our\-Threads = 0\hspace{0.3cm}{\ttfamily [static]}}}\label{pgpmac_8c_ade7ec9db5c94d6e95673eda216e13f71}


Definition at line 256 of file pgpmac.\-c.

\hypertarget{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}{\index{pgpmac.\-c@{pgpmac.\-c}!our\-\_\-sigset@{our\-\_\-sigset}}
\index{our\-\_\-sigset@{our\-\_\-sigset}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{our\-\_\-sigset}]{\setlength{\rightskip}{0pt plus 5cm}sigset\-\_\-t our\-\_\-sigset\hspace{0.3cm}{\ttfamily [static]}}}\label{pgpmac_8c_a76042459b23ade6d59ce9698d890ea89}


Definition at line 254 of file pgpmac.\-c.

\hypertarget{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}{\index{pgpmac.\-c@{pgpmac.\-c}!our\-Threads@{our\-Threads}}
\index{our\-Threads@{our\-Threads}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{our\-Threads}]{\setlength{\rightskip}{0pt plus 5cm}pthread\-\_\-t$\ast$ our\-Threads\mbox{[}32\mbox{]}\hspace{0.3cm}{\ttfamily [static]}}}\label{pgpmac_8c_aa44c2aa6014f43a397de0cfaa5a59d4f}
...
\hypertarget{pgpmac_8c_ad163e2bc6ebe322058c113dee76c11ff}{\index{pgpmac.\-c@{pgpmac.\-c}!pgpmac\-\_\-use\-\_\-autoscint@{pgpmac\-\_\-use\-\_\-autoscint}}
\index{pgpmac\-\_\-use\-\_\-autoscint@{pgpmac\-\_\-use\-\_\-autoscint}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{pgpmac\-\_\-use\-\_\-autoscint}]{\setlength{\rightskip}{0pt plus 5cm}int pgpmac\-\_\-use\-\_\-autoscint = 0}}\label{pgpmac_8c_ad163e2bc6ebe322058c113dee76c11ff}
...
\hypertarget{pgpmac_8c_ae002f31c03cce9bf96cf0e0c2907cb2b}{\index{pgpmac.\-c@{pgpmac.\-c}!pgpmac\-\_\-use\-\_\-pg@{pgpmac\-\_\-use\-\_\-pg}}
\index{pgpmac\-\_\-use\-\_\-pg@{pgpmac\-\_\-use\-\_\-pg}!pgpmac.c@{pgpmac.\-c}}
\subsubsection[{pgpmac\-\_\-use\-\_\-pg}]{\setlength{\rightskip}{0pt plus 5cm}int pgpmac\-\_\-use\-\_\-pg = 0}}\label{pgpmac_8c_ae002f31c03cce9bf96cf0e0c2907cb2b}
