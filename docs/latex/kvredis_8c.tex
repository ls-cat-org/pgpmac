...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{case} REDIS\_REPLY\_STATUS:
    printf( \textcolor{stringliteral}{"%*sSTATUS: %s\(\backslash\)n"}, indentlevel*4,\textcolor{stringliteral}{""}, r->str);
    \textcolor{keywordflow}{break};

  \textcolor{keywordflow}{case} REDIS\_REPLY\_ERROR:
    printf( \textcolor{stringliteral}{"%*sERROR: %s\(\backslash\)n"}, indentlevel*4, \textcolor{stringliteral}{""}, r->str);
    \textcolor{keywordflow}{break};

  \textcolor{keywordflow}{case} REDIS\_REPLY\_INTEGER:
    printf( \textcolor{stringliteral}{"%*sInteger: %lld\(\backslash\)n"}, indentlevel*4, \textcolor{stringliteral}{""}, r->integer);
    \textcolor{keywordflow}{break};

  \textcolor{keywordflow}{case} REDIS\_REPLY\_NIL:
    printf( \textcolor{stringliteral}{"%*s(nil)\(\backslash\)n"}, indentlevel*4, \textcolor{stringliteral}{""});
    \textcolor{keywordflow}{break};

  \textcolor{keywordflow}{case} REDIS\_REPLY\_STRING:
    printf( \textcolor{stringliteral}{"%*sSTRING: %s\(\backslash\)n"}, indentlevel*4, \textcolor{stringliteral}{""}, r->str);
    \textcolor{keywordflow}{break};

  \textcolor{keywordflow}{case} REDIS\_REPLY\_ARRAY:
    printf( \textcolor{stringliteral}{"%*sARRAY of %d elements\(\backslash\)n"}, indentlevel*4, \textcolor{stringliteral}{""}, (\textcolor{keywordtype}{int})r->elements);
    indentlevel++;
  ...
  \textcolor{keywordflow}{default}:
    printf( \textcolor{stringliteral}{"%*sUnknown type %d\(\backslash\)n"}, indentlevel*4,\textcolor{stringliteral}{""}, r->type);
...
\begin{DoxyCode}
  ...
  \textcolor{keywordtype}{char} *argv[8];
  ...
  redisAsyncCommand( \hyperlink{kvredis_8c_a498efb0426f0d925e6cab0e7104812ae}{cmdac}, NULL, NULL, \textcolor{stringliteral}{"MULTI"});
  \textcolor{keywordflow}{for}( i=0; i<PQntuples( pgr); i++) \{
    ...
    argv[0] = \textcolor{stringliteral}{"HMSET"};
    argv[1] = PQgetvalue( pgr, i, kvname\_col);
    argv[2] = \textcolor{stringliteral}{"VALUE"};
    argv[3] = PQgetvalue( pgr, i, kvvalue\_col);
    argv[4] = \textcolor{stringliteral}{"SEQ"};
    argv[5] = PQgetvalue( pgr, i, kvseq\_col);
    argv[6] = \textcolor{stringliteral}{"DBRTYPE"};
    argv[7] = PQgetvalue( pgr, i, kvdbrtype\_col);
    redisAsyncCommandArgv( \hyperlink{kvredis_8c_a498efb0426f0d925e6cab0e7104812ae}{cmdac}, NULL, NULL, 8, (\textcolor{keyword}{const} \textcolor{keywordtype}{char} **)argv, NULL
      );

    argv[0] = \textcolor{stringliteral}{"PUBLISH"};
    argv[1] = \textcolor{stringliteral}{"REDIS\_KV\_CONNECTOR"};
    argv[2] = PQgetvalue( pgr, i, kvname\_col);
    redisAsyncCommandArgv( \hyperlink{kvredis_8c_a498efb0426f0d925e6cab0e7104812ae}{cmdac}, NULL, NULL, 3, (\textcolor{keyword}{const} \textcolor{keywordtype}{char} **)argv, NULL
      );
  \}
  ...
  redisAsyncCommand( \hyperlink{kvredis_8c_a498efb0426f0d925e6cab0e7104812ae}{cmdac}, NULL, NULL, \textcolor{stringliteral}{"EXEC"});
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( redisAsyncCommand( \hyperlink{kvredis_8c_a498efb0426f0d925e6cab0e7104812ae}{cmdac}, NULL, NULL, \textcolor{stringliteral}{"KEYS *"}) == REDIS\_ERR) \{
    fprintf( stderr, \textcolor{stringliteral}{"Error sending KEYS command\(\backslash\)n"});
    exit( -1);
  \}

  \textcolor{keywordflow}{if}( redisAsyncCommand( \hyperlink{kvredis_8c_a4d65536cb1094fb5deda0a852b181232}{subac}, \hyperlink{kvredis_8c_a5dbdf77c680c97996882abbb6a142321}{debugCB}, NULL, \textcolor{stringliteral}{"PSUBSCRIBE MD2* UI*
      "}) == REDIS\_ERR) \{
