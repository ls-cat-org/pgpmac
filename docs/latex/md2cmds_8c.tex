...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( ignore == NULL) \{
    \textcolor{comment}{//}
    \textcolor{comment}{// Should generate error message}
    \textcolor{comment}{// about blank command}
    \textcolor{comment}{//}
  ...
  \textcolor{keywordflow}{if}( pos == endptr) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds moveAbs error: Can't
       decipher '%s' as a number"}, pos);
    \textcolor{keywordflow}{return};
  \}
