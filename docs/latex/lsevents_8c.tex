...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{while}( 1) \{
    ...
    \textcolor{comment}{//}
    \textcolor{comment}{// Yes, this is O(N).}
    \textcolor{comment}{//}
    \textcolor{comment}{// Plan to make this O(1):}
    \textcolor{comment}{//  track actual event names from send\_event}
    \textcolor{comment}{//  match listeners for new event names}
    \textcolor{comment}{//  store matchs in hash table}
    \textcolor{comment}{//}
    \textcolor{comment}{// That makes send\_event for new events O(N)}
    \textcolor{comment}{// but O(1) otherwise, O(N) for add\_listener, and O(1) here.}
    \textcolor{comment}{//}
    pthread\_mutex\_lock( &\hyperlink{lsevents_8c_a70bba59930a1c7d7d181aa03cdfb6c00}{lsevents\_listener\_mutex});
    \textcolor{keywordflow}{for}( p = \hyperlink{lsevents_8c_a300dc3edfa8546d75e9f8bab8fa06c5c}{lsevents\_listeners\_p}; p != NULL; p = p->\hyperlink{structlsevents__listener__struct_a8aed9196b0deab84e018b96c0cc59305}{next}
      ...
      \textcolor{keywordflow}{if}( regexec( &p->\hyperlink{structlsevents__listener__struct_a60b0f9e188a08e6101c494af89052d3f}{re}, ep->\hyperlink{structlsevents__queue__struct_a3ac2148f21e4a23ce6df588374749bda}{evp}, 0, NULL, 0) == 0) \{
        p->\hyperlink{structlsevents__listener__struct_a005906c1c9f0647e6ed1fb4592d8c5d0}{cb}( ep->\hyperlink{structlsevents__queue__struct_a3ac2148f21e4a23ce6df588374749bda}{evp});
      \}
    \}
    free( ep->\hyperlink{structlsevents__queue__struct_a3ac2148f21e4a23ce6df588374749bda}{evp});
