...
int \hyperlink{lspmac_8c_a83ba40e81c04ecc11009be6cbed0c5e1}{lspmac\-\_\-est\-\_\-move\-\_\-time} (double $\ast$est\-\_\-time, int $\ast$mmask, \hyperlink{pgpmac_8h_aa5067fcbaabc5bbfdc52492495518c96}{lspmac\-\_\-motor\-\_\-t} $\ast$mp\-\_\-1, int jog\-\_\-1, char $\ast$preset\-\_\-1, double end\-\_\-point\-\_\-1,...)
...
int \hyperlink{lspmac_8c_a1273ffacbd1a28282a019460bf6bc9b5}{lspmac\-\_\-est\-\_\-move\-\_\-time\-\_\-wait} (double move\-\_\-time, int mmask)
...
Definition at line 3355 of file lspmac.\-c.
...
Definition at line 3737 of file lspmac.\-c.
...
Definition at line 3518 of file lspmac.\-c.
...
Definition at line 3902 of file lspmac.\-c.
...
Definition at line 3449 of file lspmac.\-c.
...
Definition at line 3699 of file lspmac.\-c.
...
Definition at line 3476 of file lspmac.\-c.
...
\}
\end{DoxyCode}
\hypertarget{lspmac_8c_a83ba40e81c04ecc11009be6cbed0c5e1}{\index{lspmac.\-c@{lspmac.\-c}!lspmac\-\_\-est\-\_\-move\-\_\-time@{lspmac\-\_\-est\-\_\-move\-\_\-time}}
...
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{lspmac_8c_a83ba40e81c04ecc11009be6cbed0c5e1}
...
\hline
{\em mmask} & Mask of coordinate systems we are trying to move, excluding jogs. Used to wait for motions to complete \\
\hline
...
Definition at line 2650 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordtype}{int} \hyperlink{namespacemk__pgpmac__redis_afa643a23a5984fe44c2182ada3dfa401}{i};
  \textcolor{keywordtype}{int} m5075;            
...
\textcolor{comment}{     */}
    ...
    \textcolor{keywordflow}{if}( mp != NULL && mp->\hyperlink{structlspmac__motor__struct_a69e49769a1001665377efc7193d88a0a}{max\_speed} != NULL && mp->\hyperlink{structlspmac__motor__struct_a50cf4c0711cea164e332bc34705a1a68}{max\_accel} 
      ...
      \textcolor{keywordflow}{if}( ps != NULL && *ps != 0) \{
        err = \hyperlink{lsredis_8c_a1ad60526a09ca679f39174ce5d773abe}{lsredis\_find\_preset}( mp->\hyperlink{structlspmac__motor__struct_aa90af2f6f1489f1befe1d0891e51575a}{name}, ps, &
      maybe\_ep);
        \textcolor{keywordflow}{if}( err != 0)
          ep = maybe\_ep;
      \}
      ...
      ->\hyperlink{structlspmac__motor__struct_a7437ef16c2dce65bde4dda1ea00e9df3}{axis}) != 0) \{
        ...
        \textcolor{keywordflow}{if}( j < \textcolor{keyword}{sizeof}( axes)) \{
          ...
          motions[motor\_num - 1].\hyperlink{structlspmac__combined__move__struct_afb7613644145027494f9120d5ad42d05}{axis}      = j;
  ...
  \textcolor{comment}{// Call the motion program(s)}
  \{
    ...
    \textcolor{keywordflow}{if}( m5075 != 0) \{
      *mmask |= m5075;  \textcolor{comment}{// Tell the caller about our new mask}
      ...
      \textcolor{keywordflow}{if}( err == ETIMEDOUT) \{
        \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"lspmac\_est\_move\_time:
       Timed out waiting for moving flags.  lspmac\_moving\_flags = %0x"}, moving\_flags);
        \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"%s Move Aborted Combined
       Motors"});
        \textcolor{keywordflow}{return} 1;
      \}
    \}
    ...
    \textcolor{keywordflow}{for}( i=1; i<=16; i++) \{
      ...
      \textcolor{keywordflow}{if}( foundone) \{
        sprintf( s, \textcolor{stringliteral}{"&%d Q40=%d Q41=%d Q42=%d Q43=%d Q44=%d Q45=%d Q46=%d
       Q47=%d Q48=%d Q49=%.1f Q100=%d B180R"},
                 i, qs[0], qs[1], qs[2], qs[3], qs[4], qs[5], qs[6], qs[7], qs[
      8], *est\_time * 1000., 1 << (i-1));
...
\}
\end{DoxyCode}
\hypertarget{lspmac_8c_a1273ffacbd1a28282a019460bf6bc9b5}{\index{lspmac.\-c@{lspmac.\-c}!lspmac\-\_\-est\-\_\-move\-\_\-time\-\_\-wait@{lspmac\-\_\-est\-\_\-move\-\_\-time\-\_\-wait}}
...
\item[{int}]{mmask}
\end{DoxyParamCaption}
)}}\label{lspmac_8c_a1273ffacbd1a28282a019460bf6bc9b5}
...
\hline
{\em mmask} & A coordinate system mask to wait for\\
\hline
\end{DoxyParams}
Both values are returned from lspmac\-\_\-est\-\_\-move\-\_\-time 

Definition at line 2983 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  err = 0;
  pthread\_mutex\_lock( &\hyperlink{lspmac_8c_a85679cac947e199c88794f8e5a12bf5f}{lspmac\_moving\_mutex});
  \textcolor{keywordflow}{while}( err == 0 && (\hyperlink{lspmac_8c_a7a32c617c183166308241e270959df56}{lspmac\_moving\_flags} & mmask) != 0)
    err = pthread\_cond\_timedwait( &\hyperlink{lspmac_8c_a57547d211906c981ef20257eba99f8df}{lspmac\_moving\_cond}, &
      \hyperlink{lspmac_8c_a85679cac947e199c88794f8e5a12bf5f}{lspmac\_moving\_mutex}, &timeout);
  pthread\_mutex\_unlock( &\hyperlink{lspmac_8c_a85679cac947e199c88794f8e5a12bf5f}{lspmac\_moving\_mutex});
  ...
  \textcolor{keywordflow}{if}( err != 0) \{
    \textcolor{keywordflow}{if}( err == ETIMEDOUT) \{
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"lstest\_lspmac\_est\_move\_time:
       timed out waiting %f seconds"}, move\_time);
    \}
    \textcolor{keywordflow}{return} 1;
  \}
  \textcolor{keywordflow}{return} 0;
...
Definition at line 3962 of file lspmac.\-c.
...
Definition at line 3869 of file lspmac.\-c.
...
Definition at line 3943 of file lspmac.\-c.
...
Definition at line 3432 of file lspmac.\-c.
...
Definition at line 3534 of file lspmac.\-c.
...
Definition at line 3265 of file lspmac.\-c.
...
Definition at line 3751 of file lspmac.\-c.
...
Definition at line 3401 of file lspmac.\-c.
...
Definition at line 3017 of file lspmac.\-c.
...
Definition at line 3226 of file lspmac.\-c.
...
Definition at line 2393 of file lspmac.\-c.
...
Definition at line 2467 of file lspmac.\-c.
...
Definition at line 2563 of file lspmac.\-c.
...
Definition at line 2550 of file lspmac.\-c.
...
Definition at line 2437 of file lspmac.\-c.
...
Definition at line 3254 of file lspmac.\-c.
...
Definition at line 2493 of file lspmac.\-c.
...
Definition at line 3280 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( mp->\hyperlink{structlspmac__motor__struct_a11cbc6f50c150ed446e9a901cf7cc12b}{nlut} > 0 && mp->\hyperlink{structlspmac__motor__struct_a7b43671f7f3e06521f6cf91fb9ac707d}{lut} != NULL) \{
    ...
    \textcolor{keywordflow}{if}( abs( mp->\hyperlink{structlspmac__motor__struct_a6e8dc9c11dc52a439fe9837230f93ce2}{requested\_pos\_cnts} - mp->\hyperlink{structlspmac__motor__struct_ae5c7aea45b9637a1817be246688fd980}{actual\_pos\_cnts}
      ...
      mp->\hyperlink{structlspmac__motor__struct_a68c471836f52707fa8582f7860cf500f}{motion\_seen}  = 0;
      mp->\hyperlink{structlspmac__motor__struct_a59a7f007476b2428fd3c5bd7f24440e8}{command\_sent} = 1;
      \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"zoom Moving"});
      pthread\_mutex\_unlock( &(mp->\hyperlink{structlspmac__motor__struct_a188c5b1e991750ce2ffd53e0192e0907}{mutex}));
      ...
      mp->\hyperlink{structlspmac__motor__struct_a68c471836f52707fa8582f7860cf500f}{motion\_seen}  = 1;
      mp->\hyperlink{structlspmac__motor__struct_a59a7f007476b2428fd3c5bd7f24440e8}{command\_sent} = 1;
      \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"zoom In Position"});
      pthread\_mutex\_unlock( &(mp->\hyperlink{structlspmac__motor__struct_a188c5b1e991750ce2ffd53e0192e0907}{mutex}));
      \textcolor{keywordflow}{return} 0;
    \}
...
Definition at line 4010 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \hyperlink{lsevents_8c_ab0617d3f0594b51d10e34bf397096654}{lsevents\_add\_listener}( \textcolor{stringliteral}{"scint Moving"},         
  ...
  \hyperlink{lsevents_8c_ab0617d3f0594b51d10e34bf397096654}{lsevents\_add\_listener}( \textcolor{stringliteral}{"cam.zoom Moving"},      
...
Definition at line 3827 of file lspmac.\-c.
...
Definition at line 3712 of file lspmac.\-c.
...
Definition at line 3775 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( scint\_target > 10.0) \{
    err = \hyperlink{lspmac_8c_a83ba40e81c04ecc11009be6cbed0c5e1}{lspmac\_est\_move\_time}( &move\_time, &mmask,
    ...
    \textcolor{keywordflow}{if}( err) \{
      ...
      \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Aborting Motion"});
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"
...
Definition at line 3803 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{comment}{//}
  \textcolor{keywordflow}{if}( scint\_target < 10.0) \{
    \hyperlink{lspmac_8c_a83ba40e81c04ecc11009be6cbed0c5e1}{lspmac\_est\_move\_time}( &move\_time, &mmask,
...
Definition at line 3502 of file lspmac.\-c.
...
Definition at line 2610 of file lspmac.\-c.
...
Definition at line 3835 of file lspmac.\-c.
