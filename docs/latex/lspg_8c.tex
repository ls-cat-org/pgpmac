...
void \hyperlink{lspg_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\-\_\-query\-\_\-push} (void($\ast$cb)(\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$, P\-Gresult $\ast$), char $\ast$fmt,...)
...
void \hyperlink{lspg_8c_a329a7fdfa5025a403ea2779e178fd3ed}{lspg\-\_\-init\-\_\-motors\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
\begin{DoxyCompactList}\small\item\em Motor initialization callback. \end{DoxyCompactList}\item 
void \hyperlink{lspg_8c_af34559ab5624e1e68085dbcd9410c692}{lspg\-\_\-zoom\-\_\-lut\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
\begin{DoxyCompactList}\small\item\em Zoom motor look up table callback. \end{DoxyCompactList}\item 
void \hyperlink{lspg_8c_a71db585552ea3f58a1c9ab3fbe62bb79}{lspg\-\_\-scint\-\_\-lut\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
\item 
void \hyperlink{lspg_8c_ac5d5d512350a9ba346635e2415d7c3d5}{lspg\-\_\-flight\-\_\-lut\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
...
void \hyperlink{lspg_8c_a6f5fa5727f2876f8b9370110a92afa50}{lspg\-\_\-blight\-\_\-lut\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
...
void \hyperlink{lspg_8c_a6de3621552c9265950a0df573429c519}{lspg\-\_\-kvs\-\_\-cb} (\hyperlink{kvredis_8c_ae57432c0a6ac48a50457815dab2c5b4c}{lspg\-\_\-query\-\_\-queue\-\_\-t} $\ast$qqp, P\-Gresult $\ast$pgr)
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( i=0; i<PQntuples( pgr); i++) \{
    ...
    \textcolor{keywordflow}{if}( sp != NULL && *sp != 0) \{
      ...
      \textcolor{comment}{//}
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a1e11f525ca0f9ac9ab71f9fbe983c42b}{lspg\_cmd\_cb}, \textcolor{stringliteral}{"select
...
\begin{DoxyCode}
  ...
  uint32\_t units\_column, coord\_column, name\_column, axis\_column;
  ...
  axis\_column              = PQfnumber( pgr, \textcolor{stringliteral}{"mm\_axis"});
  ...
  \textcolor{keywordflow}{for}( i=0; i<PQntuples( pgr); i++) \{
    ...
    \textcolor{keywordflow}{for}( j=0; j<\hyperlink{lspmac_8c_a56260f012c50a591ee7f97e500f16994}{lspmac\_nmotors}; j++) \{
      \textcolor{keywordflow}{if}( strcmp(\hyperlink{lspmac_8c_a894c709ddd0652583d6db22e86282503}{lspmac\_motors}[j].name, PQgetvalue( pgr, i, 
      name\_column)) == 0) \{
        lsdp                    = &(\hyperlink{lspmac_8c_a894c709ddd0652583d6db22e86282503}{lspmac\_motors}[j]);
      ...
      format\_column));
        \textcolor{comment}{// lsdp->u2c               = atof(PQgetvalue( pgr, i, u2c\_column));}
      ...
      update\_format\_column));
        ...
        \textcolor{keywordflow}{if}( PQgetisnull( pgr, i, axis\_column))
          lsdp->\hyperlink{structlspmac__motor__struct_a79d2049141b8ec29638f96b3fb91b7f1}{axis}            = NULL;
        \textcolor{keywordflow}{else}
          lsdp->\hyperlink{structlspmac__motor__struct_a79d2049141b8ec29638f96b3fb91b7f1}{axis}            = strdup(PQgetvalue( pgr, i, axis\_column));
    ...
    \textcolor{comment}{/*}
\textcolor{comment}{    if( fabs(lsdp->u2c) <= 1.0e-9)}
\textcolor{comment}{      lsdp->u2c = 1.0;}
\textcolor{comment}{    */}
  \}
\}
\end{DoxyCode}
...
\begin{DoxyCode}
  ...
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_aa760191c2b443170cebbcbf5ea5345f3}{lspg\_lock\_detector\_cb}, \textcolor{stringliteral}{"
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{case} \hyperlink{lspg_8c_ae7ea5876846b5f04c419aee22d3c0aa1}{LS\_PG\_STATE\_INIT\_POLL}:
    ...
    \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_a69ae04978986e6413ca7cefcb692b645}{lspg\_connectPoll\_response} == 
      ...
      , NULL);
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a329a7fdfa5025a403ea2779e178fd3ed}{lspg\_init\_motors\_cb}, \textcolor{stringliteral}{"
      select * from pmac.md2\_getmotors()"});
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, \textcolor{stringliteral}{"select pmac.md2\_init()"});
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_af34559ab5624e1e68085dbcd9410c692}{lspg\_zoom\_lut\_cb}, \textcolor{stringliteral}{"SELECT
       * FROM pmac.md2\_zoom\_lut()"});
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_ac5d5d512350a9ba346635e2415d7c3d5}{lspg\_flight\_lut\_cb}, \textcolor{stringliteral}{"
      SELECT * FROM pmac.md2\_flight\_lut()"});
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a6f5fa5727f2876f8b9370110a92afa50}{lspg\_blight\_lut\_cb}, \textcolor{stringliteral}{"
      SELECT * FROM pmac.md2\_blight\_lut()"});
      \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a71db585552ea3f58a1c9ab3fbe62bb79}{lspg\_scint\_lut\_cb},      \textcolor{stringliteral}{
      ...
      \textcolor{keywordflow}{while}( 1) \{
       ...
       \textcolor{stringliteral}{"SELECT action FROM px.nextaction()"});
        \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (strstr( pgn->relname, \textcolor{stringliteral}{"\_kvs"}) != NULL) \{
          \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a6de3621552c9265950a0df573429c519}{lspg\_kvs\_cb}, \textcolor{stringliteral}{"SELECT
       pmac.getkvs()"});
        \}
        PQfreemem( pgn);
      \}
...
\begin{DoxyCode}
  ...
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( \hyperlink{lspg_8c_a11cda12050dc9a86188e15e2155a6013}{lspg\_seq\_run\_prep\_cb}, \textcolor{stringliteral}{"
