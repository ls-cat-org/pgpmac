...
void \hyperlink{md2cmds_8c_ae2ecf1ddb756452728eba479f36b486b}{md2cmds\-\_\-push\-\_\-queue} (char $\ast$action)
\item 
...
\begin{DoxyCompactList}\small\item\em Go to robot mount phase Normally this would not be called as md2cmds\-\_\-transfer would put things into the correct position If you need to change the behaviour of this function be sure to change md2cmds\-\_\-transfer as well. \end{DoxyCompactList}\item 
...
\item 
void \hyperlink{md2cmds_8c_ad6a28dfbe2ca3180364be779a461ae1d}{md2cmds\-\_\-ca\-\_\-last\-\_\-cb} (char $\ast$event)
\begin{DoxyCompactList}\small\item\em Save centering and alignment stage positions to restore on restart. \end{DoxyCompactList}\item 
void \hyperlink{md2cmds_8c_a399a5830d8b38c828042ad5b0005e896}{md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb} (char $\ast$event)
\begin{DoxyCompactList}\small\item\em restore previous md2 phase \end{DoxyCompactList}\item 
...
pthread\-\_\-t $\ast$ \hyperlink{md2cmds_8c_abc5270ece18fe48a49947378438049cf}{md2cmds\-\_\-run} ()
...
\item 
static \hyperlink{md2cmds_8c_a5d5f3ca11eadb9719ccffec6753e1385}{md2cmds\-\_\-cmd\-\_\-kv\-\_\-t} \hyperlink{md2cmds_8c_a536297b42e6510e136b202957da7244f}{md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs} \mbox{[}$\,$\mbox{]}
\end{DoxyCompactItemize}
...
Definition at line 1742 of file md2cmds.\-c.
...
Definition at line 1704 of file md2cmds.\-c.
...
Definition at line 1772 of file md2cmds.\-c.
...
\}
\end{DoxyCode}
\hypertarget{md2cmds_8c_ad6a28dfbe2ca3180364be779a461ae1d}{\index{md2cmds.\-c@{md2cmds.\-c}!md2cmds\-\_\-ca\-\_\-last\-\_\-cb@{md2cmds\-\_\-ca\-\_\-last\-\_\-cb}}
\index{md2cmds\-\_\-ca\-\_\-last\-\_\-cb@{md2cmds\-\_\-ca\-\_\-last\-\_\-cb}!md2cmds.c@{md2cmds.\-c}}
\subsubsection[{md2cmds\-\_\-ca\-\_\-last\-\_\-cb}]{\setlength{\rightskip}{0pt plus 5cm}void md2cmds\-\_\-ca\-\_\-last\-\_\-cb (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{event}
\end{DoxyParamCaption}
)}}\label{md2cmds_8c_ad6a28dfbe2ca3180364be779a461ae1d}
...
Definition at line 2027 of file md2cmds.\-c.


\begin{DoxyCode}
                                      \{
  \textcolor{keywordtype}{char} *phase;
  \textcolor{keywordtype}{char} motor\_name[64];
  ...
  phase = \hyperlink{lsredis_8c_ac1994e56114b2315294527d76311f829}{lsredis\_getstr}( \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"phase"}
      ));
  \textcolor{keywordflow}{if}( strcmp( phase, \textcolor{stringliteral}{"center"}) == 0 || strcmp( phase, \textcolor{stringliteral}{"dataCollection"}) == 0) \{
    motor\_name[0] = 0;
    \textcolor{keywordflow}{for}( i=0; i<\textcolor{keyword}{sizeof}(motor\_name)-1; i++) \{
      \textcolor{keywordflow}{if}( event[i] == \textcolor{charliteral}{' '})
        \textcolor{keywordflow}{break};
      motor\_name[\hyperlink{namespacemk__pgpmac__redis_afa643a23a5984fe44c2182ada3dfa401}{i}] = \textcolor{keyword}{event}[\hyperlink{namespacemk__pgpmac__redis_afa643a23a5984fe44c2182ada3dfa401}{i}];
      motor\_name[i+1] = 0;
    \}
    \textcolor{keywordflow}{if}( i < \textcolor{keyword}{sizeof}(motor\_name)) \{
      mp = \hyperlink{lspmac_8c_a22ef36819bdee963712691e660cfc101}{lspmac\_find\_motor\_by\_name}( motor\_name);
      \textcolor{keywordflow}{if}( mp != NULL ) \{
        \hyperlink{lsredis_8c_a2b48f29f489bcbdaf4fb29e7fbf1d4d2}{lsredis\_set\_preset}( motor\_name, \textcolor{stringliteral}{"Beam"}, 
...
Definition at line 1150 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Data Collection Starting"});
  ...
  \textcolor{comment}{//}
  \textcolor{comment}{// Go to data collection mode}
  \textcolor{comment}{//}
  \textcolor{keywordflow}{if}( \hyperlink{md2cmds_8c_a4569e8e2b269463b2a60b8407d9ce4d9}{md2cmds\_phase\_change}( \textcolor{stringliteral}{"changeMode dataCollection"})) \{
  ...
  \textcolor{keywordflow}{while}( 1) \{
    ...
    \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_ad8d8e2f578ca79189a80c1fd5b60cefd}{lspg\_nextshot}.\hyperlink{structlspg__nextshot__struct_aa50fbe34bd93ccc3762a804e95f8fd10}{query\_error}) \{
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_collect: query error
       retrieving next shot info.  aborting"});
      \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Data Collection Aborted"});
    ...
    \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT
       px.shots\_set\_state(%lld, 'Preparing')"}, skey);
    \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"
      detector.state"}), \textcolor{stringliteral}{"\{\(\backslash\)"skey\(\backslash\)": %lld, \(\backslash\)"sstate\(\backslash\)": \(\backslash\)"Preparing\(\backslash\)"\}"});
    ...
    \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_ad8d8e2f578ca79189a80c1fd5b60cefd}{lspg\_nextshot}.\hyperlink{structlspg__nextshot__struct_a1a94eefbad713976a3d9213695a6ca28}{active}) \{
      ...
      .\hyperlink{structlspg__nextshot__struct_a66e678866ce79f6398b66d033ae45a17}{az},
        ...
        err = \hyperlink{lspmac_8c_a570b4a359adc4da4ab80d53506d06963}{lspmac\_est\_move\_time\_wait}( move\_time+10,
       mmask, NULL);
        \textcolor{keywordflow}{if}( err) \{
          \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Data Collection Aborted"});
          \textcolor{comment}{//      lspg\_query\_push( NULL, NULL, "SELECT
       px.unlock\_diffractometer()");   // Should we even have the diffractometer lock at this point?}
          \hyperlink{lspg_8c_a50458a014041a4118452802dfb303960}{lspg\_nextshot\_done}();
          \textcolor{keywordflow}{return} 1;
        \}
      \}
    ...
    \textcolor{keywordflow}{if}( !\hyperlink{lspg_8c_ad8d8e2f578ca79189a80c1fd5b60cefd}{lspg\_nextshot}.\hyperlink{structlspg__nextshot__struct_a2d1f51cb1bb575a214344773136be878}{dsphi\_isnull} || !\hyperlink{lspg_8c_ad8d8e2f578ca79189a80c1fd5b60cefd}{lspg\_nextshot}
      ...
      \textcolor{keywordflow}{if}( err) \{
        \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT
       px.shots\_set\_state(%lld, 'Error')"}, skey);
        \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Data Collection Aborted"});
        \hyperlink{lspg_8c_a50458a014041a4118452802dfb303960}{lspg\_nextshot\_done}();
        \textcolor{keywordflow}{return} 1;
      \} 
    ...
    \textcolor{comment}{//}
    \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_a5d3cf153b086f5252f248d17db824917}{lspg\_seq\_run\_prep\_all}( skey,
      ...
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_collect: seq run
       prep query error, aborting"});
      \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Data Collection Aborted"});
      \textcolor{keywordflow}{return} 1;
    \}
    ...
    \textcolor{comment}{//}
    clock\_gettime( CLOCK\_REALTIME, &\hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now});
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_collect: waiting %f
       seconds for the shutter to close"}, 4 + exp\_time);
    timeout.tv\_sec  = \hyperlink{kvredis_8c_ad40ac52086f6b774928af45b09d54c6e}{now}.tv\_sec + 4 + ceil(exp\_time);       \textcolor{comment}{// hopefully 4
    ...
    \textcolor{comment}{//}
    \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT
       px.shots\_set\_state(%lld, 'Writing')"}, skey);
...
Definition at line 2011 of file md2cmds.\-c.
...
Definition at line 2013 of file md2cmds.\-c.
...
Definition at line 2015 of file md2cmds.\-c.
...
Definition at line 2017 of file md2cmds.\-c.
...
Definition at line 2019 of file md2cmds.\-c.
...
Definition at line 2021 of file md2cmds.\-c.
...
Definition at line 2072 of file md2cmds.\-c.
...
Definition at line 1128 of file md2cmds.\-c.
...
\}
\end{DoxyCode}
\hypertarget{md2cmds_8c_a399a5830d8b38c828042ad5b0005e896}{\index{md2cmds.\-c@{md2cmds.\-c}!md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb@{md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb}}
\index{md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb@{md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb}!md2cmds.c@{md2cmds.\-c}}
\subsubsection[{md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb}]{\setlength{\rightskip}{0pt plus 5cm}void md2cmds\-\_\-lspmac\-\_\-ready\-\_\-cb (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{event}
\end{DoxyParamCaption}
)}}\label{md2cmds_8c_a399a5830d8b38c828042ad5b0005e896}
...
Definition at line 2055 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( phase && phase[0] != 0) \{
    snprintf( s, \textcolor{keyword}{sizeof}(s)-1, \textcolor{stringliteral}{"changeMode %s"}, phase);
    s[\textcolor{keyword}{sizeof}(s)-1] = 0;
    \hyperlink{md2cmds_8c_a4569e8e2b269463b2a60b8407d9ce4d9}{md2cmds\_phase\_change}( s);
  \}
  \textcolor{keywordflow}{if}( phase)
    free( phase);
\}
\end{DoxyCode}
...
Definition at line 1104 of file md2cmds.\-c.
...
Definition at line 1074 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_maybe\_done\_moving\_cb:
       status code %ld"}, \hyperlink{lsredis_8c_a1923f998441f4f451204dfd214d52218}{lsredis\_getl}( \hyperlink{md2cmds_8c_a6a34fb6876abbd580629d3708c805e7f}{md2cmds\_md\_status\_code}
      ));
...
Definition at line 1633 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  pthread\_mutex\_lock( &\hyperlink{md2cmds_8c_a4ea6e6bf63aefcd49f87c3921029451d}{md2cmds\_moving\_mutex});
  \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( \hyperlink{md2cmds_8c_a6a34fb6876abbd580629d3708c805e7f}{md2cmds\_md\_status\_code}, \textcolor{stringliteral}{"
      %s"}, \textcolor{stringliteral}{"4"});
  \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_move\_prep: status code
       %ld"}, \hyperlink{lsredis_8c_a1923f998441f4f451204dfd214d52218}{lsredis\_getl}( \hyperlink{md2cmds_8c_a6a34fb6876abbd580629d3708c805e7f}{md2cmds\_md\_status\_code}));
  \hyperlink{md2cmds_8c_a5ce190461376c4f9c7d74842d8ebc5d5}{md2cmds\_moving\_count} = \hyperlink{md2cmds_8c_a5ce190461376c4f9c7d74842d8ebc5d5}{md2cmds\_moving\_count}
       ? \hyperlink{md2cmds_8c_a5ce190461376c4f9c7d74842d8ebc5d5}{md2cmds\_moving\_count} : -1;
  pthread\_mutex\_unlock( &\hyperlink{md2cmds_8c_a4ea6e6bf63aefcd49f87c3921029451d}{md2cmds\_moving\_mutex});
\}
\end{DoxyCode}
...
Definition at line 500 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( mp != NULL && mp->\hyperlink{structlspmac__motor__struct_a38b6eee046c3ceff84f908af3335ebcf}{moveAbs} != NULL) \{
    \hyperlink{pgpmac_8c_a7762ca7b97b44b979e23ce88ca3b4249}{pgpmac\_printf}( \textcolor{stringliteral}{"Moving %s to %f\(\backslash\)n"}, mtr, fpos);
...
Definition at line 579 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( mp != NULL && mp->\hyperlink{structlspmac__motor__struct_a38b6eee046c3ceff84f908af3335ebcf}{moveAbs} != NULL) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"Moving %s by %f\(\backslash\)n"}, mtr, fpos)
      ;
...
Definition at line 1047 of file md2cmds.\-c.
...
Definition at line 880 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  err = \hyperlink{lspmac_8c_a570b4a359adc4da4ab80d53506d06963}{lspmac\_est\_move\_time\_wait}( move\_time + 10.0, 
      mmask,
                                   \hyperlink{lspmac_8c_af813a2eff0b7efa4c70633559054e84c}{blight\_ud},
                                   \hyperlink{lspmac_8c_ae78d9a757d4c85419fff9c94b15e25d7}{cryo},
                                   \hyperlink{lspmac_8c_addb26c80065506faa1de3c1b468fe03f}{fluo},
                                   NULL);
  \textcolor{keywordflow}{if}( err) \{
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Mode beamLocation Aborted"});
    \textcolor{keywordflow}{return} err;
...
Definition at line 781 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  err = \hyperlink{lspmac_8c_a984a1d6e49ad53d6a1184666881bf117}{lspmac\_est\_move\_time}( &move\_time, &mmask,
                              ...
                              \hyperlink{lspmac_8c_ac940d950d9efeaf3f0ae67e9bf331188}{cenx},      0, \textcolor{stringliteral}{"Beam"}, 0.0,
                              \hyperlink{lspmac_8c_aaed18e738ba7bfb6c771a44f5d7ea827}{ceny},      0, \textcolor{stringliteral}{"Beam"}, 0.0,
                              \hyperlink{lspmac_8c_a0be79ccb7ebf3a665248fd856112b9fd}{kappa},     0, NULL,    0.0,
...
Definition at line 977 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{comment}{//}
  \textcolor{comment}{// Tangled web.  Probably not worth fixing.  O(N) but N is 6.}
  \textcolor{comment}{//}
  ...
  \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"phase"}), err ?
       \textcolor{stringliteral}{"unknown"} : mode);
...
Definition at line 830 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  err = \hyperlink{lspmac_8c_a570b4a359adc4da4ab80d53506d06963}{lspmac\_est\_move\_time\_wait}( move\_time + 10.0, 
      mmask,
                                   \hyperlink{lspmac_8c_a139200ddaa9856a7ffcec0e6cbaa8f1b}{apery},
                                   \hyperlink{lspmac_8c_ab93bd6ee850b285ca3a95e64d15e9477}{aperz},
                                   \hyperlink{lspmac_8c_a51358daaea8b5236f08414877d8af6c2}{capy},
                                   \hyperlink{lspmac_8c_aa45f268d0af9f3d465acfab128919718}{capz},
                                   \hyperlink{lspmac_8c_a589431b3a79c21c251fcb97cc9126991}{scint},
                                   \hyperlink{lspmac_8c_af813a2eff0b7efa4c70633559054e84c}{blight\_ud},
                                   \hyperlink{lspmac_8c_ae78d9a757d4c85419fff9c94b15e25d7}{cryo},
                                   \hyperlink{lspmac_8c_addb26c80065506faa1de3c1b468fe03f}{fluo},
                                   NULL);
...
Definition at line 659 of file md2cmds.\-c.
...
Go to robot mount phase Normally this would not be called as md2cmds\-\_\-transfer would put things into the correct position If you need to change the behaviour of this function be sure to change md2cmds\-\_\-transfer as well. 



Definition at line 714 of file md2cmds.\-c.
...
Definition at line 923 of file md2cmds.\-c.
...
\}
\end{DoxyCode}
\hypertarget{md2cmds_8c_ae2ecf1ddb756452728eba479f36b486b}{\index{md2cmds.\-c@{md2cmds.\-c}!md2cmds\-\_\-push\-\_\-queue@{md2cmds\-\_\-push\-\_\-queue}}
\index{md2cmds\-\_\-push\-\_\-queue@{md2cmds\-\_\-push\-\_\-queue}!md2cmds.c@{md2cmds.\-c}}
\subsubsection[{md2cmds\-\_\-push\-\_\-queue}]{\setlength{\rightskip}{0pt plus 5cm}void md2cmds\-\_\-push\-\_\-queue (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{action}
\end{DoxyParamCaption}
)}}\label{md2cmds_8c_ae2ecf1ddb756452728eba479f36b486b}
...
Definition at line 1449 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_a7ef8a09203117578c9b2ce4719519f36}{lspg\_getcenter}.\hyperlink{structlspg__getcenter__struct_a0d1be4b8199bc5ec781c3df2211335aa}{query\_error}) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_rotate: get center
       query error, aborting"});
  ...
  \textcolor{keywordflow}{if}( \hyperlink{lspmac_8c_a984a1d6e49ad53d6a1184666881bf117}{lspmac\_est\_move\_time}( &move\_time, &mmask,
                            \hyperlink{lspmac_8c_a589431b3a79c21c251fcb97cc9126991}{scint},  0,  \textcolor{stringliteral}{"Cover"}, 0.0,
                            \hyperlink{lspmac_8c_aa45f268d0af9f3d465acfab128919718}{capz},   0,  \textcolor{stringliteral}{"Cover"}, 0.0,
  ...
  \textcolor{keywordflow}{if}( \hyperlink{lspmac_8c_a570b4a359adc4da4ab80d53506d06963}{lspmac\_est\_move\_time\_wait}( move\_time + 10.0, 
      mmask,
                                 \hyperlink{lspmac_8c_ad53a42cfaa04eff0336a44c8c9986333}{zoom},
                                 NULL)) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_rotate: organ motion
       timed out %f seconds"}, move\_time + 10.0);
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Rotate Aborted"});
    \textcolor{keywordflow}{return} 1;
  \}
  ...
  ay = \hyperlink{lspmac_8c_acc46bdddee59bd8c5ad662b3fd445e9f}{lspmac\_getPosition}( \hyperlink{lspmac_8c_a737c246c3948e644a18d191a931e1acd}{aligny});
  az = \hyperlink{lspmac_8c_acc46bdddee59bd8c5ad662b3fd445e9f}{lspmac\_getPosition}( \hyperlink{lspmac_8c_ae7642b1da0f7c7f8448104c691d40a12}{alignz});
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT px.applycenter( %.3f,
       %.3f, %.3f, %.3f, %.3f, %.3f, %.3f)"}, cx, cy, ax, ay, az, \hyperlink{lspmac_8c_acc46bdddee59bd8c5ad662b3fd445e9f}{lspmac\_getPosition}
...
Definition at line 1610 of file md2cmds.\-c.


\begin{DoxyCode}
                                     \{
  \textcolor{keyword}{static} \hyperlink{structlsredis__obj__struct}{lsredis\_obj\_t} *ozt  = NULL;
  \textcolor{keyword}{struct }tm t;
  \textcolor{keywordtype}{int} usecs;

  gmtime\_r( &(\hyperlink{lspmac_8c_ae6631a094accc469661805bdf80fc6d8}{omega\_zero\_time}.tv\_sec), &t);
  
  usecs = \hyperlink{lspmac_8c_ae6631a094accc469661805bdf80fc6d8}{omega\_zero\_time}.tv\_nsec / 1000;
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT px.trigcam('%d-%d-%d
  ...
  \textcolor{keywordflow}{if}( ozt == NULL)
    ozt = \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"omega.rotate.time"});

  \hyperlink{lsredis_8c_a9b9c64f883c7ded60badfe89cb15fa78}{lsredis\_setstr}( ozt, \textcolor{stringliteral}{"\{\(\backslash\)"timestamp\(\backslash\)": \(\backslash\)"
      %04d-%02d-%02dT%02d:%02d:%02d.%06dZ\(\backslash\)", \(\backslash\)"zoom\(\backslash\)": %d, \(\backslash\)"angle\(\backslash\)": 0.0, \(\backslash\)"velocity\(\backslash\)": 90.0, \(\backslash\)"hash\(\backslash\)": \(\backslash\)"%s
      \(\backslash\)"\}"},
                  t.tm\_year+1900, t.tm\_mon+1, t.tm\_mday, t.tm\_hour, t.tm\_min, t
      .tm\_sec, usecs,
                  (\textcolor{keywordtype}{int})(\hyperlink{lspmac_8c_acc46bdddee59bd8c5ad662b3fd445e9f}{lspmac\_getPosition}( \hyperlink{lspmac_8c_ad53a42cfaa04eff0336a44c8c9986333}{zoom})), (
      \hyperlink{lspg_8c_a7ef8a09203117578c9b2ce4719519f36}{lspg\_getcenter}.\hyperlink{structlspg__getcenter__struct_a25ec9de09c01ce75f020605fe2bc38d9}{hash} == NULL ? \textcolor{stringliteral}{"unknown"} : \hyperlink{lspg_8c_a7ef8a09203117578c9b2ce4719519f36}{lspg\_getcenter}
      .\hyperlink{structlspg__getcenter__struct_a25ec9de09c01ce75f020605fe2bc38d9}{hash}));
  
\}
\end{DoxyCode}
\hypertarget{md2cmds_8c_abc5270ece18fe48a49947378438049cf}{\index{md2cmds.\-c@{md2cmds.\-c}!md2cmds\-\_\-run@{md2cmds\-\_\-run}}
...
{}
\end{DoxyParamCaption}
)}}\label{md2cmds_8c_abc5270ece18fe48a49947378438049cf}
...
Definition at line 2139 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \hyperlink{lsevents_8c_a1efedb183d9558ae0f3573712e7918b2}{lsevents\_add\_listener}( \textcolor{stringliteral}{"^LSPMAC Done Initializing$"},  
      \hyperlink{md2cmds_8c_a399a5830d8b38c828042ad5b0005e896}{md2cmds\_lspmac\_ready\_cb});
...
Definition at line 1787 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( pmatch[5].rm\_so != -1) \{
    ...
    \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}( strncmp( cmd+pmatch[5].rm\_so, \textcolor{stringliteral}{"stop"}, pmatch[5].rm\_eo-pmatch[5].
      rm\_so)==0) \{
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_run\_cmd: stopping
       motor '%s'"}, cp);
      \hyperlink{lspmac_8c_a85f7a5e4d853b7a86ddde1006dd4dc1f}{lspmac\_abort}();
    \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}( strncmp( cmd+pmatch[5].rm\_so, \textcolor{stringliteral}{"spin"}, pmatch[5].rm\_eo-pmatch[5].
      rm\_so)==0) \{
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_run\_cmd: spinning
       motor '%s'"}, cp);
      \hyperlink{lspmac_8c_a4c258e8c19f24b48e52da890a5e91375}{lspmac\_spin}( mp);
    \}
  \}
  \textcolor{keywordflow}{return} 0;
\}
...
Definition at line 1889 of file md2cmds.\-c.
...
Definition at line 1645 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( mag <=0 || mag >10) \{
    \textcolor{keywordflow}{return};
  \}
...
Definition at line 1837 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT px.settransferpoint(
       %0.3f, %0.3f, %0.3f, %0.3f, %0.3f)"}, ax, ay, az, cx, cy);
...
Definition at line 1780 of file md2cmds.\-c.
...
Definition at line 1674 of file md2cmds.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( err) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: %s"}, err == 
      2 ? \textcolor{stringliteral}{"query error looking for next sample"} : \textcolor{stringliteral}{"no sample requested to be
       transfered, false alarm"});
    \textcolor{keywordflow}{return} 1;
  \}
  ...
  \textcolor{comment}{//}
  \textcolor{comment}{// BLUMax sets up an abort dialogbox here.  TODO: We should figure out how we
  ...
  \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_af18499d17171eff473cfc49d4a0a5562}{lspg\_starttransfer}.\hyperlink{structlspg__starttransfer__struct_a5ef1d5a6708b3872761b86aef34d7aeb}{query\_error}) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: query error
       starting transfer"});
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Transfer Aborted"});
  ...
  \textcolor{keywordflow}{if}( abort\_now) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: Apparently
       there is a sample already mounted but we don't know where it is supposed to go"});
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Transfer Aborted"});
    \textcolor{keywordflow}{return} 1;
  \}
  ...
  \textcolor{comment}{//}
  \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_a68d367d98c780a95b2c347d09e9ddec3}{lspg\_waitcryo\_all}()) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: query error
       waiting for the cryo lock, aborting"});
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Transfer Aborted"});
    \textcolor{keywordflow}{return} 1;
  \}
  ...
  \hyperlink{kvredis_8c_a0bb9ef42da8fa21c4df48ec384ab69f4}{lspg\_query\_push}( NULL, NULL, \textcolor{stringliteral}{"SELECT px.dropairrights()"});

  \textcolor{comment}{// wait for the result}
  \textcolor{comment}{// TODO: find an easy way out of this in case of error}
  \textcolor{comment}{//}
  \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_a02d7dc2b8b8667b07b48d9147eb4621d}{lspg\_getcurrentsampleid\_wait\_for\_id}( 
      nextsample)) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: query error
       waiting for the sample transfer"});
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Transfer Aborted"});
    \textcolor{keywordflow}{return} 1;
  \}
  ...
  \textcolor{comment}{//}
  \textcolor{keywordflow}{if}( \hyperlink{lspg_8c_aa4cad634cac645d0366acbb25cef7b96}{lspg\_demandairrights\_all}() ) \{
    \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"md2cmds\_transfer: query error
       while demanding air rights, aborting"});
    \hyperlink{lsevents_8c_a5c6f122382dea3dcc231b772e5e75b46}{lsevents\_send\_event}( \textcolor{stringliteral}{"Transfer Aborted"});
    \textcolor{keywordflow}{return} 1;
  \}
...
Definition at line 1954 of file md2cmds.\-c.
...
\hypertarget{md2cmds_8c_a536297b42e6510e136b202957da7244f}{\index{md2cmds.\-c@{md2cmds.\-c}!md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs@{md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs}}
\index{md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs@{md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs}!md2cmds.c@{md2cmds.\-c}}
\subsubsection[{md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs}]{\setlength{\rightskip}{0pt plus 5cm}{\bf md2cmds\-\_\-cmd\-\_\-kv\-\_\-t} md2cmds\-\_\-cmd\-\_\-pg\-\_\-kvs\mbox{[}$\,$\mbox{]}\hspace{0.3cm}{\ttfamily [static]}}}\label{md2cmds_8c_a536297b42e6510e136b202957da7244f}
{\bfseries Initial value\-:}
\begin{DoxyCode}
= \{
