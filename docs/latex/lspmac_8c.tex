...
Definition at line 2768 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordtype}{double} *dp;
  ...
  \textcolor{keywordflow}{for}( i=0, dp = \hyperlink{lspmac_8c_a85d6eaa4b4a82bb3112574f458d1dc50}{blight}->\hyperlink{structlspmac__motor__struct_a7b43671f7f3e06521f6cf91fb9ac707d}{lut}; i<blight->nlut; i++, dp += 2) \{
    ...
    \}
    *dp = i;
    *(dp+1) = 20000.0 * \hyperlink{lsredis_8c_aa8daf63b794b6b6341018feec205cb7d}{lsredis\_getd}( p) / 100.0;
  \}
  pthread\_mutex\_unlock( &\hyperlink{lspmac_8c_a85d6eaa4b4a82bb3112574f458d1dc50}{blight}->\hyperlink{structlspmac__motor__struct_a188c5b1e991750ce2ffd53e0192e0907}{mutex});
\}
\end{DoxyCode}
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( i=0, dp = \hyperlink{lspmac_8c_aeb09895663eff333b7a75acb319a9fc1}{flight}->\hyperlink{structlspmac__motor__struct_a7b43671f7f3e06521f6cf91fb9ac707d}{lut}; i<flight->nlut; i++, dp += 2) \{
    ...
    \}
    *dp = i;
    *(dp+1) = 32767.0 * \hyperlink{lsredis_8c_aa8daf63b794b6b6341018feec205cb7d}{lsredis\_getd}( p) / 100.0;
  \}
  pthread\_mutex\_unlock( &\hyperlink{lspmac_8c_aeb09895663eff333b7a75acb319a9fc1}{flight}->\hyperlink{structlspmac__motor__struct_a188c5b1e991750ce2ffd53e0192e0907}{mutex});
\}
\end{DoxyCode}
...
Definition at line 2799 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( i=0, dp = \hyperlink{lspmac_8c_a8a3ca6fcf5e24dcc26170736843e53b2}{fscint}->\hyperlink{structlspmac__motor__struct_a7b43671f7f3e06521f6cf91fb9ac707d}{lut}; i<fscint->nlut; i++, dp += 2) \{
    *(dp)   = i;
    *(dp+1) = 320.0 * i;
  \}
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{if}( motor\_num == 1 && \hyperlink{lspmac_8c_ae06d2291c1996ffb7dcf7d132e25b038}{omega\_zero\_search} && *mp->
    ...
    \textcolor{keywordflow}{if}( \hyperlink{lspmac_8c_aea11895d2ec4a3324f4baa9d24cd192d}{omega\_zero\_velocity} > 0.0) \{
      ...
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}(\textcolor{stringliteral}{"lspmac\_motor\_read: omega zero
       secs %d  nsecs %d ozt.tv\_sec %ld  ozt.tv\_nsec  %ld, motor cnts %d"},
...
Definition at line 2822 of file lspmac.\-c.
...
Definition at line 2706 of file lspmac.\-c.
...
\begin{DoxyCode}
  ...
  \textcolor{keywordflow}{for}( i=1, dp = \hyperlink{lspmac_8c_ad53a42cfaa04eff0336a44c8c9986333}{zoom}->\hyperlink{structlspmac__motor__struct_a7b43671f7f3e06521f6cf91fb9ac707d}{lut}; i<=zoom->nlut; i++, dp += 2) \{
    p = \hyperlink{lsredis_8c_ad3bb3ebbae1ffbd03e062ecdd663cc6a}{lsredis\_get\_obj}( \textcolor{stringliteral}{"cam.zoom.%d.MotorPosition"}, i);
    \textcolor{keywordflow}{if}( p==NULL || strlen( \hyperlink{lsredis_8c_ac1994e56114b2315294527d76311f829}{lsredis\_getstr}(p)) == 0) \{
      ...
      \hyperlink{lslogging_8c_a0e756b36671055ef02a8f04d2ba8a93b}{lslogging\_log\_message}( \textcolor{stringliteral}{"lspmac\_zoom\_lut\_setup:
       cannot find MotorPosition element for cam.zoom level %d"}, i);
      \textcolor{keywordflow}{return};
    \}
    *dp = i;
    *(dp+1) = \hyperlink{lsredis_8c_aa8daf63b794b6b6341018feec205cb7d}{lsredis\_getd}( p);
  \}
  pthread\_mutex\_unlock( &\hyperlink{lspmac_8c_ad53a42cfaa04eff0336a44c8c9986333}{zoom}->\hyperlink{structlspmac__motor__struct_a188c5b1e991750ce2ffd53e0192e0907}{mutex});
\}
\end{DoxyCode}
